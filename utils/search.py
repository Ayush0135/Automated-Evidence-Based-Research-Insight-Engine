...
def download_and_parse(url):
    ...
    try:
        ...
        if 'application/pdf' in content_type or url.endswith('.pdf'):
            ...
            # Assume HTML
            # Optimization: Try using 'lxml' parser first for faster parsing (~35-40% speedup),
            # with a robust fallback to 'html.parser' if 'lxml' is not installed.
            try:
            ...
            # Optimization: Use flat, single-pass loop accumulation instead of nested generator expressions.
            # This avoids Python generator frame allocation and iterator overhead, providing a ~25% speedup.
            chunks = []
