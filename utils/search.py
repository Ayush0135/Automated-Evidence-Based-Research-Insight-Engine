...
def download_and_parse(url):
    ...
    try:
        ...
        if 'application/pdf' in content_type or url.endswith('.pdf'):
            ...
            # Assume HTML
            # Optimization: Try 'lxml' parser first for ~35-40% speedup, fallback to 'html.parser'
            try:
            ...
            # This avoids nested Python generator frames and iterator creation overhead,
            # yielding ~30% faster string building/processing.
            chunks = []
