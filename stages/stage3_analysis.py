    ...
    try:
        ...
        if len(full_text) > 12000:
            ...
            with ThreadPoolExecutor(max_workers=3) as chunk_executor:
                ...
                # Preserve chronological order by iterating over futures in submission order.
                for f in futures:
                    res = f.result()
...
def stage3_document_analysis(documents):
    ...
    with ThreadPoolExecutor(max_workers=2) as executor:
        # Preserve document relevance order by iterating over futures in submission order.
