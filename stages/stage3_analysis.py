...
def analyze_single_document(doc):
    try:
        ...
        # Optimization: Increased threshold to 128k to handle larger academic papers in fewer calls and reduce API overhead
...
def stage3_document_analysis(documents):
    ...
    # Increased max_workers to 6 for faster document throughput
