...
def analyze_single_document(doc):
    try:
        ...
        if len(full_text) > 12000:
            ...
            # Parallel Chunk Analysis (Mini-batch)
            # Iterate over futures in order to preserve chronological sequence of summaries
...
def stage3_document_analysis(documents):
    ...
    # Result gathering in submission order ensures original ranking is preserved
