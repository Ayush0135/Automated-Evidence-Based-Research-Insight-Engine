...
def stage2_document_discovery(decomposition_data):
    ...
    with ThreadPoolExecutor(max_workers=5) as search_executor:
        ...
        # Iterate over futures in order of submission to preserve subtopic relevance
    ...
    with ThreadPoolExecutor(max_workers=5) as executor:
        ...
        # Iterate over futures in order of submission to preserve search ranking relevance
        for future in futures:
