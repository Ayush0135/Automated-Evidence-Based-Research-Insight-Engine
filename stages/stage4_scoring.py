...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    Uses ThreadPoolExecutor to improve throughput.
    """
    print("\n--- STAGE 4: ACADEMIC SCORING (Parallel Groq) ---")
    scored_documents = []
    
    # Parallelization of scoring (3 workers as per architecture guidelines)
    # This provides a significant speedup while staying within common rate limits.
    # Results are gathered in submission order to preserve original document ranking.
