...
def score_single_document(doc, topic):
    ...
    Enables parallel processing in Stage 4.
    """
...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # max_workers=3 is a balanced choice for cloud API rate limits
    with ThreadPoolExecutor(max_workers=3) as executor:
        # To strictly preserve order, we submit and then iterate over the futures list
