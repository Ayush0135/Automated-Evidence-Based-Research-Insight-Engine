...
def score_single_document(doc, topic):
    """
    Analyzes and scores a single document based on its analysis data.
    """
...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # max_workers=3 is balanced for Groq rate limits and speed
    # We iterate over the list of futures to ensure the original document ranking is preserved.
