...
def score_single_document(doc, topic):
    """
    Worker function to score a single document using Groq.
    """
...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Parallelize scoring with 3 workers (balanced for Groq rate limits)
    # Preservation of order is important to maintain relevance ranking
    with ThreadPoolExecutor(max_workers=3) as executor:
        ...
        # Iterate over futures in the order they were submitted to preserve sequence
