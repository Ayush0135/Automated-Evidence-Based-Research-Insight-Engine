...
def score_single_document(doc, topic):
    ...
    try:
        # Scoring is a logic-heavy task, usually routed to Groq or Gemini
...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Speed Optimization: Parallelize academic scoring
    # max_workers=3 provides a good balance between speed and avoiding provider rate limits
