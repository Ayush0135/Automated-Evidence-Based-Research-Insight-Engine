...
def stage4_academic_scoring(analyzed_documents, topic):
    """
    Parallelized Stage 4 using ThreadPoolExecutor with 3 workers.
    Preserves original relevance order by iterating over futures in submission order.
    """
    print("\n--- STAGE 4: ACADEMIC SCORING (Groq Parallel) ---")
    scored_documents = []
    
    # Using 3 workers as per memory recommendation for Stage 4
