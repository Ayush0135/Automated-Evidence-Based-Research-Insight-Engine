...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Performance Optimization: Parallelize LLM scoring calls.
    # We use 3 workers as per Stage 4 concurrency guidelines.
    # Results are gathered by iterating over futures to preserve relevance ranking.
