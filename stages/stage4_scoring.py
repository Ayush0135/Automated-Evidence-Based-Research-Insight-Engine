...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Parallelize document scoring to reduce overall latency.
    # max_workers=3 is chosen to balance speed and provider rate limits.
    with ThreadPoolExecutor(max_workers=3) as executor:
        # Submit all tasks. We store futures in a list to preserve the original order.
