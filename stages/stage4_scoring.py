...
def stage4_academic_scoring(analyzed_documents, topic):
    """
    Parallelized scoring stage to improve pipeline throughput.
    Uses 3 workers to balance speed and rate limits.
    """
    ...
    with ThreadPoolExecutor(max_workers=3) as executor:
        ...
        # Iterate over futures in order to maintain the original ranking sequence
