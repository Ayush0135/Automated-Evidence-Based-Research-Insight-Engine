...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Optimization: Parallelize scoring using ThreadPoolExecutor.
    # We use 3 workers to balance speed and provider rate limits.
    # Results are gathered in submission order to preserve ranking/relevance.
