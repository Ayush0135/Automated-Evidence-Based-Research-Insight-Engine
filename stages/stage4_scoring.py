...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # 3 workers is a balanced choice for parallel LLM calls without aggressive rate limiting
    with ThreadPoolExecutor(max_workers=3) as executor:
        # Submit tasks and keep track of futures to maintain original order
