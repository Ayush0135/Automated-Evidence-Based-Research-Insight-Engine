...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Process documents in parallel with 3 workers
    # We iterate over the list of futures in the order they were submitted
    # to preserve the original relevance-based ranking.
