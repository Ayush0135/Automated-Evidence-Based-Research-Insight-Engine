...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # max_workers=3 to balance speed and rate limits, consistent with other stages
    with ThreadPoolExecutor(max_workers=3) as executor:
        # Submit all tasks and store futures in a list to preserve original document order
