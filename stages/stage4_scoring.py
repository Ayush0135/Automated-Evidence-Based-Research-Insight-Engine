...
def score_single_document(doc, topic):
    """
    Scores a single document based on its analysis.
    """
...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Process scoring in parallel to handle I/O bound LLM calls efficiently
    ...
    with ThreadPoolExecutor(max_workers=3) as executor:
        ...
        # Iterate over futures in order to maintain the original document ranking
