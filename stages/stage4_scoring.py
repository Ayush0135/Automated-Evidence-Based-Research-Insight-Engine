...
def stage4_academic_scoring(analyzed_documents, topic):
    """
    Scores documents based on academic criteria using parallel execution.
    ...
    # 3 workers is a balance between speed and rate limits
    with ThreadPoolExecutor(max_workers=3) as executor:
        # Map documents to futures while maintaining order
        futures = [executor.submit(_score_document, doc, topic) for doc in analyzed_documents]
