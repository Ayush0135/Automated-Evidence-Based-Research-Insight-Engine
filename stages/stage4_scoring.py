...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Parallelize scoring to improve throughput
    # Using 3 workers as a balance between speed and rate limits
    with ThreadPoolExecutor(max_workers=3) as executor:
        # Submit all scoring tasks
        futures = [executor.submit(score_single_document, doc, topic) for doc in analyzed_documents]
        
        # Gather results in submission order to preserve relevance-based ranking
