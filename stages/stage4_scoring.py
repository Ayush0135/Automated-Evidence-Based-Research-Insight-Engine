...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Parallelize scoring with 3 workers for optimal performance.
    # We use ThreadPoolExecutor to handle I/O-bound LLM API calls.
    with ThreadPoolExecutor(max_workers=3) as executor:
        # Submit all scoring tasks
        futures = [executor.submit(score_single_document, doc, topic) for doc in analyzed_documents]
        
        # Iterate over futures in order of submission to preserve relevance-based document ranking
