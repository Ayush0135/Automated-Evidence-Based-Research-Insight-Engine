...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Parallelize scoring using ThreadPoolExecutor
    # 3 workers as per Stage 4 convention seen in other stages/benchmarks
    with ThreadPoolExecutor(max_workers=3) as executor:
        # Map documents to futures
        future_to_doc = [executor.submit(score_single_document, doc, topic) for doc in analyzed_documents]
        
        # Gather results in submission order to maintain document ranking
