...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Using ThreadPoolExecutor to parallelize scoring.
    # max_workers=3 is a balance between speed and rate limits/local LLM capacity.
    with ThreadPoolExecutor(max_workers=3) as executor:
        ...
        # Iterate over futures in submission order to preserve document order
