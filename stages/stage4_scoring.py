...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Process documents in parallel to speed up the scoring stage
    # max_workers=3 matches the synthesis and chunk analysis patterns
    with ThreadPoolExecutor(max_workers=3) as executor:
        ...
        # Gather results in the original order to preserve ranking
