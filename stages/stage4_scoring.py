...
def score_single_document(doc, topic):
    ...
    Encapsulated for parallel execution.
    """
...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # ⚡ Optimization: Parallelize scoring to reduce sequential wait time for LLM responses.
    # max_workers=3 is a safe balance for Groq rate limits.
    scored_documents = []
