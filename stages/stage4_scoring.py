...
def score_single_document(doc, topic):
    """
    Worker function to score a single document using an LLM.
    """
...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # PERFORMANCE OPTIMIZATION: Parallelize document scoring
    # LLM calls are I/O bound. Using 3 workers as a balance between speed
    # and avoiding provider rate limits.
    with ThreadPoolExecutor(max_workers=3) as executor:
        ...
        # Gather results in SUBMISSION ORDER to preserve chronological/relevance sequence
        # Important for Stage 5 filtering and downstream synthesis.
        scored_documents = []
