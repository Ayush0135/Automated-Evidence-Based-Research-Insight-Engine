...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Parallelize document scoring to improve pipeline throughput.
    # We use 3 workers as a conservative default to balance speed and API rate limits.
    with ThreadPoolExecutor(max_workers=3) as executor:
        ...
        # Iterate over futures in the order they were submitted to preserve document order
