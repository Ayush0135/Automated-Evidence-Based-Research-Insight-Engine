...
def score_single_document(doc, topic):
    """
    Analyzes and scores a single document based on academic quality.
    """
...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Parallel scoring with 3 workers (optimized for Groq/Ollama mix)
    with ThreadPoolExecutor(max_workers=3) as executor:
        # Submission order is preserved by iterating over futures in submission sequence
