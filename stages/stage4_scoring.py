...
def score_single_document(doc, topic):
    ...
    try:
        ...
        print(f"  x Error scoring document {doc.get('title', 'Unknown')[:20]}: {e}")
        return None
...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Parallelize scoring with 3 workers to improve throughput while avoiding excessive rate limits
