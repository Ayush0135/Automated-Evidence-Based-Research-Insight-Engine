...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Stage 4 optimization: Use ThreadPoolExecutor with 3 workers
    # to parallelize API-bound scoring calls.
    with ThreadPoolExecutor(max_workers=3) as executor:
        # Submit tasks in order
        futures = [executor.submit(score_single_document, doc, topic) for doc in analyzed_documents]
        
        # Iterate over futures in order of submission to preserve document relevance
