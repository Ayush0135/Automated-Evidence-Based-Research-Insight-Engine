...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Parallelize scoring to improve performance.
    # Use 3 workers to stay within typical rate limits while achieving ~3x speedup.
    # We iterate over futures in the order they were submitted to preserve document ranking.
