...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Process documents in parallel to reduce sequential LLM latency
    # Use 3 workers to balance speed and rate limit constraints
    scored_documents = []
    ...
    with ThreadPoolExecutor(max_workers=3) as executor:
        ...
        # Gather results as they complete to keep UI responsive,
        # but we iterate in submission order to preserve ranking if needed
