...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # max_workers=3 to balance speed and Groq rate limits
    with ThreadPoolExecutor(max_workers=3) as executor:
        # Using list comprehension with executor.submit to maintain original document order
        ...
        for future in futures:
            ...
            if result:
                ...
                print(f"  + Scored: {result['title'][:30]}... (Score: {result['scoring'].get('score')})")
