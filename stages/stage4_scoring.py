...
def stage4_academic_scoring(analyzed_documents, topic):
    ...
    # Using ThreadPoolExecutor to score documents in parallel.
    # 3 workers is a safe balance for rate limits and speed.
    with ThreadPoolExecutor(max_workers=3) as executor:
        # Submit all tasks and keep track of them to preserve order
