...
**Learning:** Parallelizing Stage 4 with 3 workers reduced mock execution time for 6 documents by 3x (e.g., from 3.00s to 1.01s), achieving significant throughput gains while preserving document order.
